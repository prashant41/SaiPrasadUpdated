...
try {
    $sql = "SELECT * FROM revenue ORDER BY date DESC, id ASC";
    $stmt = $pdo->query($sql);
...
<head>
    ...
    <title>Manage Cash Entries</title>
...
<!-- Main Content Area -->
<div class="content">
    <h2>Manage Cash Entries</h2>
    <!-- Create Cash Entry Form -->
    <div class="create-form">
        <h3>Create New Cash Entry</h3>
        <form action="create_cash_entry.php" method="post">
            ...
            <input type="submit" value="Create Cash Entry">
        </form>
    </div>

    <h2>Cash Entries List</h2>
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['counter_cash']); ?></td>
                <td><?php echo htmlspecialchars($row['delivery_boy_cash']); ?></td>
                <td><?php echo htmlspecialchars($row['book_cash']); ?></td>
                <td class="action-buttons">
                    <a href="update_cash.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="update">Update</a>
                    <a href="delete_cash.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="delete" onclick="return confirm('Are you sure you want to delete this cash entry?');">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
